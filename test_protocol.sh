...
echo -e "\n${CYAN}--------------------------------- PORT 80 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 80:${NC}"
...
echo -e "\n${CYAN}--------------------------------- PORT 8081 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 8081:${NC}"
...
echo -e "\n${CYAN}--------------------------------- PORT 8082 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 8082:${NC}"
...
echo -e "\n${CYAN}--------------------------------- PORT 8083 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 8083:${NC}"
...
echo -e "\n${CYAN}--------------------------------- PORT 8084 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 8084:${NC}"
...
echo -e "\n${CYAN}--------------------------------- PORT 8085 ----------------------------${NC}"
echo -e "${YELLOW}[ТЕСТ] Проверка ноды на порту 8085:${NC}"
